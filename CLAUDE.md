...
- `skills/ohospatch/references/fixit.d.js` `@version` **must equal** `Fixit.runtimeVersion` in `ohospatch/src/main/cpp/runtime/fixit.js` (currently `1.15.0`). Signatures, constraints, and globals in the declaration must match the runtime.
