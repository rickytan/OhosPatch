...
- `.agents/skills/ohospatch-patch-authoring/` is the repository-local AI authoring Skill. Keep it aligned with `fixit.d.js`, README limitations, and demonstrated Runtime behavior.
